...
<div class="inner-containe">
        <div><label><input class="inner-container-input" type="checkbox" on:change={checkAllToDos}>CheckAll
        </label></div>
...
<div class="inner-container">
        <div>
            ...
            <button on:click={() => updateFilter('completed')} class:active="{currentFilter === "completed"}">All</button>}>
            </button>
        </div>
        <div>
